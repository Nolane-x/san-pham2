...
- **Readable label overlays** — grounded AI Analyze labels are materialized as deterministic editable Canvas text layers; service-owned slots update idempotently while manual text remains untouched, and a genuinely regenerated image invalidates stale grounding/labels until it is analyzed again.
