...
- **Readable label overlays** — grounded AI Analyze labels are materialized as deterministic editable Canvas text layers after image generation or analysis; service-owned slots update idempotently while manual text layers remain untouched.
